    ...
    <div class="w-full overflow-hidden bg-white mt-5 mb-5 rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="p-6">
            <div class="flex justify-between align-center">
                ...
                <h1>{{ $serviceStacs[0]->id }}</h1>
                <h1>{{ $serviceStacs[0]->icon }}</h1>
                <h1>{{ $serviceStacs[0]->titre }}</h1>
                <h1 class="flex">
                    <a  href="/dashboard/serviceStac/{{ $serviceStacs[0]->id }}/edit"
